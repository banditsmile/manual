        ...
        !function a(b, c, e) {
            ...
            !function (e, h, p, n, k, g, q, j, l, m, i, b, c, d, f, o) {
                ...
                e = function (a, c) {
                    ...
                    var b = {left: 0, top: 0, width: $(a).outerWidth(), height: $(a).outerHeight(), zIndex: 9999}, c = e(a, 'zIndex');
                ...
                }, b.version = '1.1.7', f = {moviePath: 'ZeroClipboard.swf', trustedDomains: null, text: null, hoverClass: 'zeroclipboard-is-hover', activeClass: 'zeroclipboard-is-active', allowScriptAccess: 'sameDomain'}, b.setDefaults = function (b) {
            ...
            var c = typeof self !== 'undefined' ? self : typeof window !== 'undefined' ? window : {}, e = c.ZeroClipboard = h('ZeroClipboard'), g = {path: 'ZeroClipboard.swf', copy: null, beforeCopy: null, afterCopy: null, clickAfter: !0}, f = function (a) {
                return a = 0, function () {
                    return a++
                }
            }(), d = {}, b, a = jQuery;
...
//给父层添加下拉列表的展开收起的折叠效果
     ...
     */
    (function () {
        var dytree = $('#navigation', topDocument);
    ...
    (function () {
        ...
        (function () {
            ...
            //非火狐下第二次打开不用重新注册事件
            if (!($.browser.msie) && $('#offer', topDocument).prop('loaded')) {
                return false
            }
            ;
